...
#######################################################################################
"""
Created on : __26th October 2023___
@author:     __Ekagra Jain___
...
def gor3(x,y,z):
    '''Or of three inputs.'''
    return gor(x,y) or gor(y,z) or gor(z,x)
...
def FA(x,y,cin):
    ...
    return gor3((gand(x,y)),(gand(x,cin)),(gand(cin,y))),XOR(XOR(x,y),cin)
...
def fourBitAdd(xxxx,yyyy):
    ...
    (l,zp) = FA(xxxx[1],yyyy[1],d)
    (m,zh) = FA(xxxx[0],yyyy[0],l)
    
    return (m,(zh,zp,zt,zo))
